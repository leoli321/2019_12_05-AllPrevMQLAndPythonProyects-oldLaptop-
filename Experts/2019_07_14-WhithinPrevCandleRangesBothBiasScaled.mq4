...
void OnTick()
  {
     ...
     StopLoss = StopLoss - MarketInfo(Symbol(),MODE_SPREAD) ; //* Scale despues de market info.
     ...
     //What if to scale it I just tell it to make the same 20 trades, instead of increasing lot_size.
      ...
      if(iClose(Symbol(),BarTimeFrame,1) > ThisWeek4HHighestClose ){
         ...
         (iClose(Symbol(),BarTimeFrame,1) < PrevWeek4HHighestClose)    
            ...
            OpenOrder[x] = OrderSend(Symbol(),OP_BUY,ScaledLot_size,Ask,3,NULL,NULL,NULL,NULL,NULL);
            x += 1;
         }            
         ...
         (iClose(Symbol(),BarTimeFrame,1) > PrevWeek4HLowestClose)    
            ...
            OpenOrder[x] = OrderSend(Symbol(),OP_SELL,ScaledLot_size,Bid,3,NULL,NULL,NULL,NULL,NULL);
            x += 1;
         }           
         ///////////ENTRADASFINOrden1
     ...
     if(AccountProfit() > ScaledTakeProfit){
      CloseAllOrders();
      IsSecondTradeOpen = 0;
     }
